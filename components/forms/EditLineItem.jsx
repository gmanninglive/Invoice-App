...
export default function EditLineItem({line_items}) {
   const {line_name, description, price, quantity, vat } = line_items[0];
      ...
      <div className="flex justify-between">
        <div className="col-span-1">
          ...
          <input
            ...
            defaultValue={line_name ? line_name : ""}
          />
          <div>
        ...
        <div className="m-4">
          ...
          <select name="vat" className="h-10 w-16 mx-2 rounded-md" defaultValue={vat}>
            <option value={0} >
              0%
            </option>
            <option value={0.05} >
